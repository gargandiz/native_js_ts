...
export function sumOther(a: number, b: number) {
    return a + b;
}
...
export function addSkillOther(st: StudentType, skill: string) {
...
export function createMessage(props: CityType) {
    // return "Hello " + props.title + " citizen. I want you be happy. All " + props.citizensNumber + " men";
    return `Hello ${props.title} citizen. I want you be happy. All ${props.citizensNumber} men`;
}