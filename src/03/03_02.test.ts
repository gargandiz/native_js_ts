...
test("Greeting message should be correct fot the city", () => {
    // const message = createMessage(city);
    // expect(message).toBe("Hello New York citizen. I want you be happy. All 1000000 men");

    expect(createMessage(city)).toBe("Hello New York citizen. I want you be happy. All 1000000 men");
})